  ...
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="detailOrderModalLabel" style="width: 100%"></h5>
                ...
                <div class="card card-plain h-100">
                  ...
                  <div class="card-body p-3">
                    <ul class="list-group">
                      ...
                      <li class="list-group-item border-0 ps-0 text-sm" id="detaileasonCancelModalOrder"></li>
                      <li class="list-group-item border-0 ps-0 text-sm" id="returnStatusModalOrder"></li>
                      ...
                      <li class="list-group-item border-0 ps-0 text-sm" id="jumlahBayarModalOrder"></li>
