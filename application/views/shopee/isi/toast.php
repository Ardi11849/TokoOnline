<div class="position-fixed top-1 end-1 z-index-3">
	<div class="toast fade hide p-2 bg-gradient-success" role="alert" aria-live="assertive" id="successToast" aria-atomic="true">
		<div class="toast-header border-0">
			...
			<span class="me-auto font-weight-bold">Berhasil </span>
			<i class="fas fa-times text-md ms-3 cursor-pointer" data-bs-dismiss="toast" aria-label="Close"></i>
		</div>
		<hr class="horizontal dark m-0">
		<div class="toast-body" style="color: white;" id="isiToastSuccess">
		</div>
	</div>
	<div class="toast fade hide p-2 mt-2 bg-gradient-danger" role="alert" aria-live="assertive" id="dangerToast" aria-atomic="true">
		<div class="toast-header border-0">
			...
			<span class="me-auto text-gradient text-danger font-weight-bold">Gagal </span>
			<i class="fas fa-times text-md ms-3 cursor-pointer" data-bs-dismiss="toast" aria-label="Close"></i>
		</div>
		<hr class="horizontal dark m-0">
		<div class="toast-body" style="color: white;" id="isiToastGagal">
		</div>
	</div>
</div>