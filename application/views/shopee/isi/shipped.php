	          		...
	          		<div class="card my-4">
	            		<div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
			              	<div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
			                	<h6 class="text-white text-capitalize ps-3">Tabel Shipped Orderan</h6>
			              	</div>
	            		</div>
	              			...
	              			<div class="table-responsive p-0">
							  	<div class="row">
								    <div class="col">
								      ...
								      <input type="text" class="form-control" id="tanggalAwalShipped" placeholder="Tanggal awal">
								    </div>
								    <div class="col">
								    	<label>Tanggal Akhir</label>
								      <input type="text" class="form-control" id="tanggalAkhirShipped" placeholder="Tanggal akhir">
								    </div>
							  	</div>
							  	<div class="row">
							  		<div class="col">
							  			<button class="btn btn-primary" id="btn-searchShipped"><i class="fa fa-search"></i> Cari</button>
							  		</div>
							  	</div>
				                <table class="table align-items-center mb-0" id="tShipped">
				                  <thead>
				                    <tr>
